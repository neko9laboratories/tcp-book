...
int main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("access_delay2", "Access link delay", access_delay2);
  ...
  LocalLink2.SetDeviceAttribute ("DataRate", StringValue (access_bandwidth));
  ...
  for (int i = 0; i < num_flows; i++)
    {
      ...
      if(i == 0) {
        ...
        devices = LocalLink2.Install (sources.Get (i), gateways.Get (0));
      }
  ...
  if (pcap)
    {
      ...
      LocalLink2.EnablePcapAll (prefix_file_name, true);
    }
